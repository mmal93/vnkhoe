<?php
/* Smarty version 3.1.29, created on 2016-01-28 16:59:06
  from "E:\Xampp\Xam5_6_12\htdocs\vnkhoe\templates\users\vnkhoe\header.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_56aa3aca355389_22472576',
  'file_dependency' => 
  array (
  ...
  'includes' => 
  array (
    'file:account\\\\header_logout.tpl' => 2,
    'file:account\\\\header_login.tpl' => 2,
    'file:top_search.tpl' => 1,
  ),
),false)) {
function content_56aa3aca355389_22472576 ($_smarty_tpl) {
?>
...
">
		...
		<?php if ($_smarty_tpl->tpl_vars['root_config']->value->head->keywords) {?><meta name="keywords" content="<?php echo $_smarty_tpl->tpl_vars['root_config']->value->head->keywords;?>
"><?php }?>
		<?php if ($_smarty_tpl->tpl_vars['root_config']->value->head->description) {?><meta name="description" content="<?php echo $_smarty_tpl->tpl_vars['root_config']->value->head->description;?>
"><?php }?>
		<?php if (isset($_smarty_tpl->tpl_vars['_DESCRIPTION']->value)) {?><meta name="description" content="<?php echo $_smarty_tpl->tpl_vars['_DESCRIPTION']->value;?>
"><?php }?>
		<?php if (isset($_smarty_tpl->tpl_vars['_KEYWORDS']->value)) {?><meta name="keywords" content="<?php echo $_smarty_tpl->tpl_vars['_KEYWORDS']->value;?>
"><?php }?>
...
?>
		<?php }?>
		<?php if ($_smarty_tpl->tpl_vars['root_config']->value->head->favorite_icon) {?>
			<link rel="shortcut icon" type="image/icon" href="<?php echo $_smarty_tpl->tpl_vars['MEDIA_URL']->value;
echo $_smarty_tpl->tpl_vars['root_config']->value->head->favorite_icon;?>
" />  
		<?php }?>
	</head>
...
contacts.html"><span>Danh bạ</span></a></li>
					<li class="level-0"><a href="<?php echo $_smarty_tpl->tpl_vars['BASE_URL']->value;?>
jobs.html"><span>Việc làm</span></a></li>
					<li class="level-0"><a href="<?php echo $_smarty_tpl->tpl_vars['BASE_URL']->value;?>
tu_van_nghe_nghiep.html"><span>Tư vấn nghề nghiệp</span></a></li>
					<li class="level-0"><a href="<?php echo $_smarty_tpl->tpl_vars['BASE_URL']->value;?>
tu_van_suc_khoe.html"><span>Tư vấn sức khỏe</span></a></li>
				</nav>
...
jobs.html"><span>Việc làm</span></a></li>
				<li class="level-0"><a href="<?php echo $_smarty_tpl->tpl_vars['BASE_URL']->value;?>
tu-van-nghe-nghiep.html"><span>Tư vấn nghề nghiệp</span></a></li>
				<li class="level-0"><a href="<?php echo $_smarty_tpl->tpl_vars['BASE_URL']->value;?>
tu-van-suc-khoe.html"><span>Tư vấn sức khỏe</span></a></li>
			</nav>
			<?php if (isset($_smarty_tpl->tpl_vars['_session']->value) && (!empty($_smarty_tpl->tpl_vars['_session']->value))) {?>
				<?php $_smarty_tpl->smarty->ext->_subtemplate->render($_smarty_tpl, "file:account\\header_logout.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?>

			<?php } else { ?>
				<?php $_smarty_tpl->smarty->ext->_subtemplate->render($_smarty_tpl, "file:account\\header_login.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?>
	...
	<!--end top-header-->
	<?php if (isset($_smarty_tpl->tpl_vars['banner_images']->value) && (!empty($_smarty_tpl->tpl_vars['banner_images']->value))) {?>
...
?>
	...
	<?php }?>
	<?php if (isset($_smarty_tpl->tpl_vars['_top_search']->value) && ($_smarty_tpl->tpl_vars['_top_search']->value == true)) {?>
		<?php $_smarty_tpl->smarty->ext->_subtemplate->render($_smarty_tpl, "file:top_search.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
