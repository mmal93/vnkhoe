...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_56aa1e03746af7_46064004',
  'file_dependency' => 
  array (
...
function content_56aa1e03746af7_46064004 ($_smarty_tpl) {
?>
<!--partner_link-->
<section class="<?php echo $_smarty_tpl->tpl_vars['_partner_data']->value->class_name;?>
" <?php if (isset($_smarty_tpl->tpl_vars['_partner_data']->value->background) && $_smarty_tpl->tpl_vars['_partner_data']->value->background != '') {?>style="background-color: <?php echo $_smarty_tpl->tpl_vars['_partner_data']->value->background;?>
;"<?php }?>>
	<?php if (isset($_smarty_tpl->tpl_vars['_partner_data']->value->title) && $_smarty_tpl->tpl_vars['_partner_data']->value->title != '') {?>
		<div class="section-title">
			<h2><?php echo $_smarty_tpl->tpl_vars['_partner_data']->value->title;?>
</h2>
		</div>
	<?php }?>
	<?php
$_from = $_smarty_tpl->tpl_vars['_partner_data']->value->rows;
...
?>
		<div class="row <?php echo $_smarty_tpl->tpl_vars['section']->value->class_name;?>
">
