		...
		<div class="row">
			<div class="col-sm-3">
				...
				<div class="col-sm-3 col-right">
					<a href="{$BASE_URL}contacts/id/{$_hot_data[$i].congty_id}"><img src="{$MEDIA_URL}images/companies/{$_hot_data[$i].congty_id}/{$_hot_data[$i].congty_logo}" title="{$_hot_data[$i].congty_name}" style="max-width: 100%;" /></a>
				</div>
			</div>
